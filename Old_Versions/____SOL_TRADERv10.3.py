...
"""                     ---------Notes: 10.2.3 ----------
* Step Size keeps breaking & MArgin -> REverted open and close methods to 6.1 that work
* added sleep until next 15 min candle instead of hardcoded time
* remove get precision method since we've reverted main method and don't use it
                        --------------------------
"""
